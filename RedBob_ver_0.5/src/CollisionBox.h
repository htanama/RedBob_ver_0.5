...
public:
	...
	void CollisionCheck_PlayerAndTile_HitBlockForItem(CollisionBox& HitBox, Player* player, Object* object, Level* LevelMap, Mix_Chunk *BumpSound, Mix_Chunk *ObjectAppearSound, int Row, int Col)
	{
		if (mCollisionBox.x < HitBox.getPosX() + HitBox.getWidth() &&
			mCollisionBox.x + mCollisionBox.w > HitBox.getPosX() &&
			mCollisionBox.y < HitBox.getPosY() + HitBox.getHeight() &&
		...
		{		
			...
			{				
				...
				if(object->getIsObjectAppears() == false){
					...
					Mix_PlayChannel(-1, ObjectAppearSound, 0);
	...
	void CollisionCheck_PlayerAndObject_CollectSpecialItem(CollisionBox& HitBox, Player* player, Object* object, Mix_Chunk* CollectSound)
	{
		if (mCollisionBox.x < HitBox.getPosX() + HitBox.getWidth() &&
			mCollisionBox.x + mCollisionBox.w > HitBox.getPosX() &&
			mCollisionBox.y < HitBox.getPosY() + HitBox.getHeight() &&
	...
	void CollisionCheck_PlayerAndTile_FallingDeath(CollisionBox& HitBox, Player *player, Level* LevelMap, Mix_Chunk* playerDiesSound,int Row, int Col)
	{
		if (mCollisionBox.x < HitBox.getPosX() + HitBox.getWidth() &&
			mCollisionBox.x + mCollisionBox.w > HitBox.getPosX() &&
			mCollisionBox.y < HitBox.getPosY() + HitBox.getHeight() &&
			mCollisionBox.y + mCollisionBox.h > HitBox.getPosY())
		{
			...
			Mix_PlayChannel(-1, playerDiesSound, 0);
		}
	}
	...
	void CollisionCheck_PlayerAndEnemy_FallingDeath(CollisionBox& HitBox, Player* player, Enemy *enemy, Mix_Chunk* playerDiesSound)
	{
		if (mCollisionBox.x < HitBox.getPosX() + HitBox.getWidth() &&
			mCollisionBox.x + mCollisionBox.w > HitBox.getPosX() &&
			mCollisionBox.y < HitBox.getPosY() + HitBox.getHeight() &&
